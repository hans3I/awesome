...
theme.font = 'MesloLGL NF 10'
theme.barfont = 'MesloLGL NF 12'
...
theme.titlebar_minimize_button_normal = gears.color.recolor_image(theme_path.."minimize.svg", theme.fg_normal)
theme.titlebar_minimize_button_focus = gears.color.recolor_image(theme_path.."minimize.svg", theme.fg_focus)

theme.titlebar_close_button_normal = gears.color.recolor_image(theme_path.."close.svg", theme.fg_normal)
theme.titlebar_close_button_focus = gears.color.recolor_image(theme_path.."close.svg", theme.fg_focus)
...
theme.layout_floating = gears.color.recolor_image(theme_path .."floatingw.png", theme.fg_normal)
theme.layout_tile = gears.color.recolor_image(theme_path .."tilew.png", theme.fg_normal)
